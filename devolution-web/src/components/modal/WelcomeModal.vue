...
<template>
  <div class="relative z-10" role="dialog" aria-modal="true" :class="{ hidden: !visible }">
    <div class="fixed inset-0 bg-blue0 bg-opacity-75 transition-opacity"></div>
              ...
              <div class="mt-3 text-center sm:mt-0 sm:text-left">
                ...
                <div class="mt-2">
                  ...
                  <p class="text-sm mt-4">
                    ...
                    remember, every action has a cost and a consequence. The more you work, the more
                    pressure you will face. Can you handle it?
                  </p>
                </div>
              </div>
            </div>
